...
namespace Bramble.Core
{
    ...
    public class Array2D<T>
    {
        ...
        /// <summary>
        /// Gets the bounds of the array. The top-level Vecinate will be the origin.
        /// </summary>
        ...
        /// Gets and sets the array element at the given position.
        /// </summary>
        /// <param name="x">The X-Vecinate of the element.</param>
        /// <param name="x">The Y-Vecinate of the element.</param>
        /// <exception cref="IndexOutOfBoundsException">if the position is out of bounds.</exception>
