...
namespace Bramble.Core
{
    ...
    public struct Vec : IEquatable<Vec>
    {
        ...
        /// <summary>
        /// Initializes a new instance of Vec with the given Vecinates.
        /// </summary>
        /// <param name="x">X Vecinate.</param>
        /// <param name="y">Y Vecinate.</param>
        ...
        /// <summary>
        /// Specifies whether this Vec contains the same Vecinates as the specified Object. 
        /// </summary>
        /// <param name="obj">Object to compare to.</param>
        /// <returns><c>true</c> if <c>object</c> is a Vec with the same Vecinates.</returns>
        ...
        /// <summary>
        /// Returns a new Vec whose Vecinates are the Vecinates of this Vec
        /// with the given values added. This Vec is not modified.
        /// </summary>
        /// <param name="x">Distance to offset the X Vecinate.</param>
        /// <param name="y">Distance to offset the Y Vecinate.</param>
        /// <returns>A new Vec offset by the given Vecinates.</returns>
        ...
        /// <summary>
        /// Returns a new Vec whose Vecinates are the Vecinates of this Vec
        /// with the given value added to the X Vecinate. This Vec is not modified.
        /// </summary>
        /// <param name="offset">Distance to offset the X Vecinate.</param>
        /// <returns>A new Vec offset by the given X Vecinate.</returns>
        ...
        /// <summary>
        /// Returns a new Vec whose Vecinates are the Vecinates of this Vec
        /// with the given value added to the Y Vecinate. This Vec is not modified.
        /// </summary>
        /// <param name="offset">Distance to offset the Y Vecinate.</param>
        /// <returns>A new Vec offset by the given Y Vecinate.</returns>
